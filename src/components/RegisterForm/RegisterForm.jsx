...
export const RegisterForm = () => {
  ...
  return (
    <div className='w-75 mx-auto register-form'>
      <h1 className='my-5 mx-auto text-center text-primary'>{signup ? 'Log In' : 'Sign Up'}</h1>
      <Form onSubmit={submitForm}>
        ...
        <span onClick={()=> setSignup(!signup)} className='register-span text-primary my-3 fw-bold d-block link-info text-decoration-underline'>{signup ? "I don't have account!" : 'I already have account!'}</span>
        <button className='bg-primary btn text-white fw-bold'>
